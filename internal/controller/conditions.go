...
const (
	conditionABICompatible    = "ABICompatible"
	conditionInjected         = "Injected"
	conditionInstalled        = "Installed"
	conditionWorkersAvailable = "WorkersAvailable"
)

// Finalizers.
const (
	pluginFinalizer = "jellyfin.jellyops.io/plugin-teardown"
)
