...
var _ = BeforeSuite(func() {
	...
	// Plugin delivery relies on image volumes, which are beta-but-off-by-default
	// in the envtest apiserver. Enable the gate so ImageVolumeSource fields
	// persist instead of being silently stripped.
	testEnv.ControlPlane.GetAPIServer().Configure().Append("feature-gates", "ImageVolume=true")
